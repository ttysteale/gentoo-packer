...
# distfiles source
distfiles_url=http://mirror.bytemark.co.uk/gentoo

build_arch="amd64"
build_proc="amd64"
stage3current=\`curl -s \${distfiles_url}/releases/\${build_arch}/autobuilds/latest-stage3-\${build_proc}.txt|grep -v "^#"|awk '{print \$1}'\`
